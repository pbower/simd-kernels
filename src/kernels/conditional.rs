...
macro_rules! impl_conditional_copy_numeric {
    ($fn_name:ident, $fn_name_to:ident, $ty:ty, $mask_elem:ty, $lanes:expr, $array_ty:ident) => {
        ...
        pub fn $fn_name_to(
            ...
            let len = mask.len;
            assert_eq!(len, output.len(), concat!(stringify!($fn_name_to), ": output length mismatch"));
...
impl_conditional_copy_numeric!(conditional_copy_i8, conditional_copy_i8_to, i8, i8, W8, IntegerArray);
#[cfg(feature = "extended_numeric_types")]
impl_conditional_copy_numeric!(conditional_copy_u8, conditional_copy_u8_to, u8, i8, W8, IntegerArray);
#[cfg(feature = "extended_numeric_types")]
impl_conditional_copy_numeric!(conditional_copy_i16, conditional_copy_i16_to, i16, i16, W16, IntegerArray);
#[cfg(feature = "extended_numeric_types")]
impl_conditional_copy_numeric!(conditional_copy_u16, conditional_copy_u16_to, u16, i16, W16, IntegerArray);
impl_conditional_copy_numeric!(conditional_copy_i32, conditional_copy_i32_to, i32, i32, W32, IntegerArray);
impl_conditional_copy_numeric!(conditional_copy_u32, conditional_copy_u32_to, u32, i32, W32, IntegerArray);
impl_conditional_copy_numeric!(conditional_copy_i64, conditional_copy_i64_to, i64, i64, W64, IntegerArray);
impl_conditional_copy_numeric!(conditional_copy_u64, conditional_copy_u64_to, u64, i64, W64, IntegerArray);
impl_conditional_copy_numeric!(conditional_copy_f32, conditional_copy_f32_to, f32, i32, W32, FloatArray);
impl_conditional_copy_numeric!(conditional_copy_f64, conditional_copy_f64_to, f64, i64, W64, FloatArray);

#[cfg(feature = "datetime")]
impl_conditional_copy_datetime!(conditional_copy_datetime32, conditional_copy_datetime32_to, i32, i32, W32);
#[cfg(feature = "datetime")]
impl_conditional_copy_datetime!(conditional_copy_datetime64, conditional_copy_datetime64_to, i64, i64, W64);
