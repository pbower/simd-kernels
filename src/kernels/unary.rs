...
macro_rules! impl_unary_neg_int {
    ($fn_name:ident, $fn_name_to:ident, $ty:ty, $lanes:expr) => {
        ...
        pub fn $fn_name_to(input: &[$ty], output: &mut [$ty]) {
            assert_eq!(input.len(), output.len(), concat!(stringify!($fn_name_to), ": input/output length mismatch"));
...
pub fn unary_negate_u32_to_i32_to(input: &[u32], output: &mut [i32]) {
    assert_eq!(input.len(), output.len(), "unary_negate_u32_to_i32_to: input/output length mismatch");
...
pub fn unary_negate_u64_to_i64_to(input: &[u64], output: &mut [i64]) {
    let len = input.len();
    assert_eq!(len, output.len(), "unary_negate_u64_to_i64_to: input/output length mismatch");
...
macro_rules! impl_unary_neg_float {
    ($fname:ident, $fname_to:ident, $ty:ty, $lanes:expr) => {
        ...
        pub fn $fname_to(input: &[$ty], output: &mut [$ty]) {
            assert_eq!(input.len(), output.len(), concat!(stringify!($fname_to), ": input/output length mismatch"));
